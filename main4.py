...
class Cube(object):
    ...
    def draw(self, surface, eyes=False):
        ...
        rw =self.pos[0]
        cm = self.pos[1]
        pygame.draw.rect(surface, self.color, (rw * dis + 1, dis -2, dis -2))

        if eyes:
            center = dis // 2
            radius = 3
            circle_middle = (rw * dis + center - radius, cm * dis + 8)
            circle_middle2 = (rw * dis + center - radius * 2, cm * dis + 8)
                ...
                for i, c in enumerate(self.body):
                    ...
                    if p in self.turns:
                        ...
                        if i == len(self.body) -1:
                            ...
                            if c.dirnx == -1 and c.pop[0] <=0:
                                c.pop = (c.rows - 1, c.pos[1])
                            elif c.drinx == 1 and c.pop[0] >= c.rows -1:
                                c.pos = (0, c.pos[1])
                            elif c.dirny == 1 and c.pop[1] <=0:
                                c.pos =(c.pop[0], c.rows -1)
                            else:
